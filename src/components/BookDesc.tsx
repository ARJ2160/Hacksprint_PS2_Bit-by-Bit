        ...
        <section className="text-gray-700 overflow-hidden bg-white">
            <div className="container px-5 py-24 mx-auto">
                        <div className="lg:w-4/5 mx-auto flex flex-wrap" key={bookDesc._id}>
                            <img alt="ecommerce" className="lg:w-1/2 w-full object-center rounded border border-gray-200" src={bookDesc.thumbnailUrl} />
                            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                <h2 className="text-sm text-gray-500 tracking-widest mb-5">Home/{bookDesc.title}</h2>
                                    <h1 className="text-gray-900 text-3xl title-font mb-5">{bookDesc.title}</h1>
                                <div className="flex mb-4">
                                    ...
                                    <div className="flex">
                                        <span className="title-font font-medium text-2xl text-gray-900 mb-5">$ { bookDesc.price }</span>
                                    </div>
